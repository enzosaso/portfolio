...
export const filterHashtag = () => {
  const ccc = document.querySelector('.informations .right .filter .ccc')
  const current = document.querySelector('.informations .right .filter .current')
  const a = document.querySelectorAll('.informations .right .filter a')
  const filter = document.querySelector('.informations .right .filter')
  a.forEach(e => {
...
function currentLinkFilter(ccc, e) {
  ...
  var menuleft = document.querySelector('.informations .right .filter').offsetLeft
...
const hashtag = () => {
  const ccc = document.querySelector('.header .menu .ccc')
  const current = document.querySelector('.header .menu .current a')
...
export const Servicehashtag = () => {
  const ccc = document.querySelector('.service .ccc')
  const current = document.querySelector('.service .current')
  const a = document.querySelectorAll('.service .service_list ul li')
  const filter = document.querySelector('.service .service_list')
